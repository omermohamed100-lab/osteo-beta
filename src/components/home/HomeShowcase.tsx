...
const PATHS = [
  {
    href: '/find-osteopath',
    title: 'I need an osteopath',
    titleAr: 'أحتاج إلى ممارس أوستيوباثي',
    body: 'Browse listed osteopaths and their published professional information.',
    bodyAr: 'تصفّح ممارسي الأوستيوباثي المدرجين ومعلوماتهم المهنية المنشورة.',
    action: 'Find an osteopath',
    actionAr: 'ابحث عن ممارس أوستيوباثي',
    tone: 'dark',
    icon: PersonIcon,
  ...
  },
  {
    ...
    action: 'Explore courses and training',
    actionAr: 'استكشف الدورات والتدريب',
    tone: 'light',
    icon: GraduateIcon,
